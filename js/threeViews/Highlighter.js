    ...
    addRemoveVoxel: function(shouldAdd){
        ...
        if (shouldAdd){
            ...
            if (dmaGlobals.lattice.get("connectionType") == "freeformFace"){
                ...
                dmaGlobals.lattice.addFreeFormCell(this.mesh.position.clone(), this.highlightedObject.getOrientation(), this.direction, this.highlightedObject.getType(), 'bluePaper');
                return;
            }
